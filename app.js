/* LyricSlide Pro - Core Logic v15.0 (Integrated Generation & Transposition) */

const App = {
    version: "15.0", // <--- ADDED: Central version control
    ...
    elements: {
        ...
        versionDisplay: document.getElementById('versionDisplay'), // <--- ADDED: Reference to UI element
    ...
    init() {
        ...
        console.log(`App Initialized. Version ${this.version} (Auto-Template)`); // <--- UPDATED to use variable
    },
